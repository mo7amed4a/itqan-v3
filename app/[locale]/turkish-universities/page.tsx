...
export default async function UniversityPage({
  ...
  const { partial_scholarships: partial_scholarshipsLang } =
  ...
  return (
    <div className='space-y- container mx-auto mb-10 p-4 6xl:!container lg:max-w-[85vw]'>
      ...
      <div>
        <ul className='hidden-scrollbar mb-5 mt-4 flex gap-4 overflow-x-auto text-base md:mt-0 md:text-lg [&>li]:pb-2'>
      ...
      {data &&
        ...
        data.featured_universities.length > 0 && (
          <div className='hidden space-y-5 md:mt-8 md:block lg:px-16'>
                    ...
                    return (
                      ...
                      >
                        <CardUniversityTwo
                          lng={locale}
                          btnText={
                            turkish_universities.universityInfo.registerNow
                          }
                          university={item}
                        />
                      </LinkApp>
