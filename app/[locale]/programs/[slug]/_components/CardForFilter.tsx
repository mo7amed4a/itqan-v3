...
export default async function CardForProgram({ data, lng}: CardFullProps) {
        ...
        <LinkApp href={`/universities/${data.university_slug}`} >
          <div className="flex justify-between items-center w-full gap-5">
            <Image
              ...
              height={100}
            />
            <span className="text-gray-500 text-base text-start w-full">
              {data.university_name}
            </span>
          </div>
          <div className="pt-2">
            <h3 className="text-gray-600 font-bold text-xl ps-2">{data.program_name}</h3>
          </div>
        </LinkApp>
        ...
        <div className="bg-gray-400/10 text-gray-800 flex justify-between w-full gap-4 rounded-lg text-sm p-3 ">
          <div className="flex flex-col items-center gap-2">
            <div className="flex gap-4 items-center">
                ...
                <span>{partial_scholarships.fees.before}</span>
            </div>
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span>{partial_scholarships.fees.after}</span>
            </div>
              <span className="text-secondary">${data.total_fees}</span>
          </div>
        </div>
