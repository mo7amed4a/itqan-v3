...
export default function CardUniversityHomeClient({
  university,
  btnText,
  dataLang
}:{
    ...
    <div className="shadow-none bg-white rounded-2xl p-3 shadow-all duration-300 group mt-4">
      <div className="relative">
        ...
        <Image
          ...
          width={500}
          height={500}
          className="size-16 md:size-28 rounded-full absolute start-4 -bottom-10 md:-bottom-16 z-10 border-4 bg-white"
      ...
      <div className="p-4 mt-8 md:mt-16 text-start">
        ...
        <section className="space-y-3 pt-3">
          <div className="w-full gap-2 md:items-center text-gray-800 text-xs md:text-sm text-center grid grid-cols-2 md:grid-cols-4">
            ...
            <div className="bg-gray-400/10 rounded-lg p-1 md:p-2 flex flex-col items-center md:space-y-4">
              <span className="text-primary">{dataLang?.rank_1}</span>
