...
export default function RegisterPage({
  ...
  const { locale: lng } = useParams() as { locale: string };
  const searchParams = useSearchParams();
  // const [isOpen, setIsOpen] = useState(
  //   searchParams.get("booking") ? true : false
  // );
  ...
  return (
    <div className="p-4 max-w-md mx-auto">
      ...
      <div className="px-4">
        <Button className="w-full md:w-2/6 text-black bg-gray-200 hover:!scale-x-100 ">
